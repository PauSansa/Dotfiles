...
# Fix Java resolution problem
export _JAVA_AWT_WM_NONREPARENTING=1

# Created by newuser for 5.9
source /home/sansa/powerlevel10k/powerlevel10k.zsh-theme
...
# ZSH Synxtax Hightlightning Plugin
...
function settarget(){
    ip_address=$1
    machine_name=$2
    echo "$ip_address $machine_name" > /home/sansa/.config/bin/target
}
...
function cleartarget(){
    echo '' > /home/sansa/.config/bin/target
}
